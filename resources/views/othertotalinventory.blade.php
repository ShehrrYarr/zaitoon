    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="ml-1">
                    <form method="GET" action="{{ route('otherTotalInventory', $id) }}" class="mb-3 d-flex align-items-center">
                        ...
                        <a href="{{ route('otherTotalInventory', $id) }}" class="btn btn-secondary mx-1">Reset</a>
                    </form>
                </div>
