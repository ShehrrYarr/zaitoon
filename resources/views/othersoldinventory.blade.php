    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            @endif
                ...
                <div class="ml-1">
                    <form method="GET" action="{{ route('othersoldinventory', $id) }}" class="mb-3 d-flex align-items-center">
                        ...
                        <a href="{{ route('othersoldinventory', $id) }}" class="btn btn-secondary mx-1">Reset</a>
                    </form>
                </div>
